...
class TikTokCatalogFormatter implements ChannelFormatterInterface
{
    ...
    public function toXml(array $feed, array $options = []): string
    {
        return $this->writer->rowsToXml(
            $this->rowBuilder->tikTokRows($feed, $options),
            'catalog_feed',
            'product',
    ...
    public function toJson(array $feed, array $options = []): string
    {
        $json = json_encode(
            [
                ...
                'items' => $this->rowBuilder->tikTokRows($feed, $options),
            ],
    ...
    {
        return $this->writer->rowsToCsv($this->rowBuilder->tikTokRows($feed, $options));
    }
}
