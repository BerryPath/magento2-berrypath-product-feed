...
class CatalogFormatter implements ChannelFormatterInterface
{
    ...
    public function toXml(array $feed, array $options = []): string
    {
        return $this->writer->rowsToXml(
            $this->rowBuilder->catalogRows($feed, $options),
            'catalog_feed',
            'product',
    ...
    public function toJson(array $feed, array $options = []): string
    {
        $json = json_encode(
            [
                ...
                'items' => $this->rowBuilder->catalogRows($feed, $options),
            ],
    ...
    {
        return $this->writer->rowsToCsv($this->rowBuilder->catalogRows($feed, $options));
    }
}
